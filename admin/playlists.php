...
if(isset($_POST['delete'])){
   ...
   $message[] = 'Materi terhapus!';
   }else{
      $message[] = 'Materi terlah dihapus!';
   }
}
...
<section class="playlists">
   ...
   <h1 class="heading">Tambahkan Materi</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">Buat Materi baru</h3>
         <a href="add_playlist.php" class="btn">Tambahkan Materi</a>
      </div>
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('Hapus materi ini?');" name="delete">
         </form>
