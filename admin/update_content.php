...
if(isset($_POST['update'])){
   ...
   $update_content = $conn->prepare("UPDATE `content` SET title = ?, description = ?, game = ?, status = ?  WHERE id = ?");
   $update_content->execute([$title, $description, $game, $status, $video_id]);
...
<section class="video-form">
   ...
   <h1 class="heading">Silakan Perbarui</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="Tuliskan judul video" class="box" value="<?= $fecth_videos['title']; ?>">
      <p>Perbarui Deskripsi <span>*</span></p>
      <textarea name="description" class="box" required placeholder="Tuliskan deskripsi" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      <p>Perbarui Materi</p>
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>Pilih salah satu materi</option>
         <?php
         ...
         <?php
            ...
            echo '<option value="" disabled>Belum tersedia materi!</option>';
         }
         ?>
      </select>
      <img src="../uploaded_files/<?= $fecth_videos['thumb']; ?>" alt="">
      <p>Perbarui Gambar Video</p>
      <input type="file" name="thumb" accept="image/*" class="box">
      <video src="../uploaded_files/<?= $fecth_videos['video']; ?>" controls></video>
      <p>Perbarui Video</p>
      <input type="file" name="video" accept="video/*" class="box">
      <p>Perbarui Pranala <span>*</span></p>
      <textarea name="game" class="box" required placeholder="Tuliskan pranala" maxlength="500" cols="30" rows="10"><?= $fecth_videos['game']; ?></textarea>      
      <input type="submit" value="Perbarui" name="update" class="btn">
      <div class="flex-btn">
   ...
   <?php
         ...
         echo '<p class="empty">Video tidak tersedia! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
      }
   ?>
