...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="status" class="box" required>
         <option value="" selected disabled>Pilih salah satu status</option>
         <option value="active">Aktif</option>
         <option value="deactive">Tidak aktif</option>
      </select>
      <p>Judul Materi <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="Tuliskan judul materi" class="box">
      ...
      <p>Unggah Gambar Materi <span>*</span></p>
      <input type="file" name="image" accept="image/*" required class="box">
      <!-- <p>playlist link <span>*</span></p>
      <input type="link" name="image" accept="image/*" required class="box"> -->
