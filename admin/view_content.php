...
<section class="view-content">
   ...
   <?php
      ...
      echo '<p class="empty">Belum terdapat video yang ditambahkan! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
   }
   ...
   <div class="container">
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <a href="<?= $game; ?>" class="btn btn-primary">Klik Pranala Disini</a>
   ...
   <div class="show-comments">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('Anda yakin menghapus komentar ini?');">delete comment</button>
         </form>
      </div>
      <?php
       }
      }else{
         echo '<p class="empty">Belum terdapat komentar yang ditambahkan!</p>';
      }
      ?>
      </div>
