...
if(isset($_POST['delete_video'])){
   ...
   if($verify_video->rowCount() > 0){
      ...
      $message[] = 'Video terhapus!';
   }else{
      $message[] = 'Video telah terhapus!';
   }
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Hapus Materi" class="delete-btn" onclick="return confirm('Anda yakin menghapus materi ini?');" name="Hapud">
         </form>
      </div>
   </div>
   <?php
         ...
         echo '<p class="empty">Tidak ada materi yang tersedia!</p>';
      }
   ?>
...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('Anda yakin menghapus video ini?');" name="delete_video">
         </form>
   ...
   <?php
         ...
         echo '<p class="empty">Belum ada video yang ditambahkan! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Tambah Video</a></p>';
      }
   ?>
