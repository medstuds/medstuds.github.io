...
if(isset($_POST['save_list'])){
   ...
   if($user_id != ''){
      ...
      $message[] = 'Masuk akun terlebih dahulu!';
   }
...
<head>
   ...
   <title>Daftar Tema Pembelajaran</title>
...
<section class="playlist">
   ...
   <h1 class="heading">Detail Tema Pembelajaran</h1>
   ...
   <div class="row">
      ...
      <?php
            ...
            echo '<p class="empty">Materi ini tidak tersedia!</p>';
         }  
      ?>
...
<section class="videos-container">
   ...
   <h1 class="heading">Daftar Video</h1>
   ...
   <div class="box-container">
      ...
      <?php
            ...
            echo '<p class="empty">Belum terdapat video yang ditambahkan!</p>';
         }
      ?>
