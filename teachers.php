...
<section class="teachers">
   ...
   <h1 class="heading">Pengajar Ahli</h1>
   ...
   <div class="box-container">
      ...
      <!-- <div class="box offer">
         ...
         <a href="admin/register.php" class="inline-btn">Daftarkan dirimu</a>
      </div> -->
      ...
      <div class="box">
         ...
         <p>Daftar putar : <span><?= $total_playlists; ?></span></p>
         <p>Total video : <span><?= $total_contents ?></span></p>
         <p>Total disukai : <span><?= $total_likes ?></span></p>
