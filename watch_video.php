...
if(isset($_POST['update_now'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'Komentar telah berhasil diubah!';
   }
...
<section class="watch-video">
   ...
   <div class="flex-btn">
            ...
            <a href="<?= $game; ?>" class="btn btn-primary">Klik Link Disini</a>
...
<!-- click link section starts -->

<!-- click link section ends -->
