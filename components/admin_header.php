...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="dashboard.php" class="logo">Halaman Pengajar</a>
      ...
      <div class="profile">
         ...
         <a href="../components/admin_logout.php" onclick="return confirm('Anda yakin keluar?');" class="delete-btn">Keluar</a>
         <?php
            }else{
         ?>
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="playlists.php"><i class="fa-solid fa-bars-staggered"></i><span>Materi</span></a>
      ...
      <a href="../components/admin_logout.php" onclick="return Konfirmasi('Anda yakin keluar?');"><i class="fas fa-right-from-bracket"></i><span>Keluar</span></a>
   </nav>
