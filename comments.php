...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'Komentar berhasil diunggah';
   }else{
...
<section class="edit-comment">
   ...
   <form action="" method="post">
      ...
      <textarea name="update_box" class="box" maxlength="1000" required placeholder="Silakan tulis komentar disini" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
      ...
      <?php
         ...
         if($select_comments->rowCount() > 0){
            while($fetch_comment = $select_comments->fetch(PDO::FETCH_ASSOC)){
               ...
               $fetch_ = $select_content->fetch(PDO::FETCH_ASSOC);
      ?>
